...
const lookup = async (query, { enko, google, example, strip, stem, json, limit, partOfSpeech, origin }) => {
  ...
  return lookupMeaning(query, { enko, google, strip, limit, partOfSpeech, origin });
};
...
const main = async () => {
  const cli = meow({
    ...
    flags: {
      ...
      stem: { type: 'boolean', default: false, alias: 's' },
